...
function Catogary() {
    ...
    const handleRedirect = () => {
        // Redirect logic here
        navigate('/Search'); // Use the navigate function from useNavigate
    };
        ...
        <>
            <div className="main">
                ...
                <div className="onimage">
                    ...
                    <button type='submit' className='btn2' onClick={handleRedirect}><span class="material-symbols-outlined">
                        search
                    </span>Search</button>
